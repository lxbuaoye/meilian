      ...
      samples: [
        {
          ...
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt001-min.png`,
        },
        {
          name: '山东白麻',
          caseNumber: 'DT-002',
          description: '白麻石，白色多，灰点，没有黑点，可参考荆洲瓷砖来样；调白',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt002-min.png`,
        },
      ],
    },
  ],
      ...
      samples: [
        {
          ...
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt003-min.png`,
        },
        {
          name: '翠碧石',
          caseNumber: 'DT-004',
          description: 'DG-010 做DG-008大小的彩点',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt004-min.png`,
        },
      ],
    },
  ],
      ...
      samples: [
        {
          ...
          caseNumber: 'DT-005',
          description: 'DG-008',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt005-min.png`,
        },
        {
          name: '大地灰',
          caseNumber: 'DT-006',
          description: 'DG-018 做DG-008大小的彩点',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt006-min.png`,
        },
      ],
    },
  ],
      ...
      samples: [
        {
          ...
          caseNumber: 'DT-007',
          description: 'DGJ-003',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt007-min.png`,
        },
        {
          name: '富贵红',
          caseNumber: 'DT-008',
          description: 'DGJ-005',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt008-min.png`,
        },
      ],
    },
  ],
      ...
      samples: [
        {
          ...
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt009-min.png`,
        },
        {
          name: '英国棕',
          caseNumber: 'DT-008',
          description: 'DF-4490 （海南特调）',
          imageSrc: `${CLOUD_STROAGE_PATH}/resources/wuxing/dt010-min.png`,
        },
      ],
    },
  ],
...
Page({
  ...
  onDirectionChange(e) {
    this.setData({ directionValue: e.detail.value });
  },
