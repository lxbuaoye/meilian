...
Page({
  ...
  async generate() {
    const selectedColor1 = this.selectComponent(`#option-0`);
    const selectedColor2 = this.selectComponent(`#option-1`);

    if (selectedColor1.data.value === 0 && selectedColor2.data.value === 0) {
      this.showInfoMessage('至少选择一种颜色😯');
      return;
    }
